...
export * from './src/app/modules/ngx-completer/services/local-data.service';
export * from './src/app/modules/ngx-completer/services/completer.service'
export * from './src/app/modules/ngx-completer/model/completer-item';